...
export const STADIUM_ROOMS=Object.freeze([
 Object.freeze({name:'홈플레이트 연습장',hint:'출구 쪽으로 좁아집니다 · 넓은 뒤쪽에서 투구를 흘린 뒤 베이스를 타세요',covers:[wall(-6.15,2.25,2.2,1),wall(6.15,2.25,2.2,1)],enemies:[['pitcher',-3.7,-4.7],['pitcher',3.7,-4.7],['runner',0,-3.6]]}),
