...
const ALL_LAWS={
 ...
 orbit:{name:'공전',form:'위성 꽃잎',icon:'◎',color:0x9ca8ff,desc:'세 꽃잎이 돌며 적을 베어 밀어내고, 닿는 일반 적 탄환을 막습니다. 보스 탄은 통과합니다.',upgrade:'꽃잎 +1 · 피해·반경 증가',hint:'꽃잎으로 탄막을 막으며 적 사이를 파고드세요'},
 ...
 frost:{name:'빙결',form:'서리 봉오리',icon:'❄',color:0x9af0ff,desc:'같은 적에게 5발을 연속 적중시키면 얼음이 깨집니다. 보스는 멈추지 않지만 파쇄 추가 피해를 크게 받습니다',upgrade:'둔화 40% → 60% · 지속 연장',hint:'보스에게 5발을 집중해 파쇄하세요'},
