...
export const THEMES=Object.freeze({
 botanical:Object.freeze({id:'botanical',name:'잠든 정원',short:'기본',motion:'outward',palette:Object.freeze([0x76ffd0,0xffd36a,0x73dfff]),trailWidth:1,trailLife:1,portalSides:6,flame:1}),
 void:Object.freeze({id:'void',name:'VOID · 심연 균열',short:'VOID',motion:'inward',palette:Object.freeze([0x8b6cff,0x42e8ff,0xd274ff]),trailWidth:1.35,trailLife:1.3,portalSides:7,flame:.65}),
 cyber:Object.freeze({id:'cyber',name:'CYBER · 네온 회로',short:'CYBER',motion:'axis',palette:Object.freeze([0x00f0ff,0xff3bd4,0xb6ff35]),trailWidth:.78,trailLife:.72,portalSides:4,flame:.8}),
 celestial:Object.freeze({id:'celestial',name:'CELESTIAL · 별의 정원',short:'CELESTIAL',motion:'spiral',palette:Object.freeze([0xffe89a,0x9ec8ff,0xffffff]),trailWidth:1.12,trailLife:1.18,portalSides:5,flame:1.15})
});
