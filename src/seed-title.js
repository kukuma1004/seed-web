...
export function createSeedTitle(player,{austin=false,alwaysBeginner=false,discovered=0,total=Infinity,badges=[],equipped=''}={}){
 ...
 let current={austin:Boolean(austin),alwaysBeginner:Boolean(alwaysBeginner),discovered,total,badges:Array.isArray(badges)?[...badges]:[],equipped},state=titleState(current);
