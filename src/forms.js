...
export const CURATED_FORMS=Object.freeze(Object.fromEntries([
 ...
 form('frostnet',['chain','frost'],'얼어붙은 그물','번개가 세 적 이상을 이으면 연결된 무리를 한꺼번에 얼리고 서리 줄이 남습니다. 홀로 남은 보스에게는 짧은 피해 줄만 남깁니다.','연결된 무리와 줄 사이의 적을 함께 얼림','문지기·보스는 서리 줄에 닿아도 멈추지 않음'),
