...
perfMark(PS.enemyAI);crowdTimer-=dt;if(crowdTimer<=0&&!roomCleared){spawnCrowd(2);crowdTimer=crowdInterval(cycle)*(isAct3(region)?act3RoomPressure(stage).crowdInterval:isAct2(region)?ACT2_PRESSURE.crowdInterval:1);}
