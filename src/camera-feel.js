...
export function createCameraFeel(){
 ...
 function follow(dt,{playerX=0,playerZ=0,moveX=0,moveZ=0,followX=.14,followZ=.06,baseZoom=1}={}){
  ...
  const targetX=playerX*followX+leadX,targetZ=playerZ*followZ+.4+leadZ;
