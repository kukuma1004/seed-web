...
import {RUN_BONUS_MAX,emptyRunBonuses,normalizeRunBonuses,validRunBonuses,runBonusOffers,applyRunBonus,moveScale,shotScale,powerScale,runBonusSummary} from '../src/run-bonuses.js';
...
console.log('작은 성장: 회복·이동·탄속·공격 선택, 순환 제안, 최대치와 한 판 한정 수치 통과');
