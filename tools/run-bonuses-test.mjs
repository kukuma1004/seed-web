...
import {RUN_BONUSES,RUN_BONUS_MAX,RUN_BONUS_CHANCE,emptyRunBonuses,normalizeRunBonuses,validRunBonuses,runBonusOffers,rareRunBonusOffers,applyRunBonus,moveScale,cadenceScale,cadenceInterval,shotScale,powerScale,runBonusSummary} from '../src/run-bonuses.js';
