...
for(const mobile of [false,true]){
  ...
  for(let i=0;i<70;i++){
    fx.impact(a,'reflect',true);fx.reflect(a,dir);fx.split(a,dir,5);fx.arc(a,b);fx.dash(a,.3);fx.evolution(a,'chain');fx.trail(a,b);
  }
  fx.update(.016);
...
console.log('VFX capacity, input isolation, finite transforms, expiry, reset and GPU resource disposal passed.');
