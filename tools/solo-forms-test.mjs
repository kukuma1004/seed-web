...
assert.equal(Object.keys(ALL_FORMS).length,65);assert.equal(new Set(Object.values(ALL_FORMS).map(f=>f.name)).size,65);
assert.equal(eligibleForms(Object.keys(LAWS)).length,20,'fusion offers never include solo evolutions');
