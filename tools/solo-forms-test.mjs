...
assert.equal(Object.keys(ALL_FORMS).length,64);assert.equal(new Set(Object.values(ALL_FORMS).map(f=>f.name)).size,64);
assert.equal(eligibleForms(Object.keys(LAWS)).length,19,'fusion offers never include solo evolutions');
