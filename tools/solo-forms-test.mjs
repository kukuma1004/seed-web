...
assert.equal(Object.keys(ALL_FORMS).length,70);assert.equal(new Set(Object.values(ALL_FORMS).map(f=>f.name)).size,70);
assert.equal(eligibleForms(Object.keys(LAWS)).length,25,'fusion offers never include solo evolutions');
