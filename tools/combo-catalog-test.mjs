...
// 자동 재융합 990개는 계속 차단. SECOND_FORMS에는 손으로 만든 재융합만 묶음으로 들어간다(9/22 공명형 5 · 교차형 5, 9/23 섞음 5 — 모두 보류).
assert.ok(Object.values(SECOND_FORMS).every(v=>v.curated&&!v.generated),'자동 재융합은 실제 목록에 없음');
assert.equal(Object.keys(SECOND_FORMS).length,15);
...
console.log('combo catalogue archive: 10 laws, 45 first, 990 second; live gate: 20 curated first, 0 generated second, 15 curated second held (3 batches)');
