...
assert.equal(Object.keys(FORMS).length,13,'실제 선택에는 손으로 다듬은 1차 융합만');
assert.equal(Object.keys(GENERATED_FORMS).length,32,'남은 자동 생성 1차 융합은 연구 목록에만 보관');
...
console.log('combo catalogue archive: 10 laws, 45 first, 990 second; live gate: 13 curated first, 0 generated second');
