...
import {titleState,codexNews,codexSteps,CODEX,AUSTIN_MOVE_SPEED,FIRST_GARDEN_TITLE} from '../src/titles.js';
...
{const s=titleState({discovered:7});assert.deepEqual(s.titles,[]);assert.equal(s.shown,null);close(s.shotSpeed,1);close(s.moveSpeed,1);assert.equal(s.next.need,13);assert.match(s.next.reward,/칭호/);}
