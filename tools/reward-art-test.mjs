...
assert.ok(fs.statSync(new URL('../public/assets/seed-comethalo-card-v1.webp',import.meta.url)).size<120_000,'comet card stays mobile-sized');
assert.ok(fs.statSync(new URL('../public/assets/seed-comethalo-sprite-v1.webp',import.meta.url)).size<120_000,'comet orbit sprite stays mobile-sized');
assert.ok(fs.statSync(new URL('../public/assets/seed-orbit-sprites-v1.webp',import.meta.url)).size<250_000,'shared orbit sprite atlas stays mobile-sized');
assert.ok(fs.statSync(new URL('../public/assets/seed-orbit-advanced-v1.webp',import.meta.url)).size<250_000,'advanced orbit sprite atlas stays mobile-sized');
